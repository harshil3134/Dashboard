...
if(user==password)
{
 ...
 <div className="h-2/3 w-1/4 bg-gray-100 mx-auto rounded-xl mt-8 ">
        <form className="flex flex-col items-center  text-gray-800 text-xl pt-5 w-full" onSubmit={(e)=>checkUser(e,email,password)}>
            ...
            <div className="flex flex-col mt-10 w-3/4">
                ...
                <input type="text" className="bg-gray-100 p-3 border-b-2"  placeholder="abc@gmail.com" onChange={(e)=>handleChange(e,"email")} required/>
            </div>
            <div className="flex flex-col mt-6 w-3/4">
                <label  className="my-1 ">Password</label>
                <input type="text" className="bg-gray-100 p-3 border-b-2"   placeholder="Password" onChange={(e)=>handleChange(e,"password")} required/>
            </div>
            <button type="Submit" className="w-4/5 py-2 my-9 mx-6   bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500   rounded-3xl font-bold text-white " >
                Login
            </button>
